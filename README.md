...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pysparkling-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12290&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pysparkling-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pysparkling` can be installed with:

```
conda install pysparkling
```

It is possible to list all of the versions of `pysparkling` available on your platform with:
